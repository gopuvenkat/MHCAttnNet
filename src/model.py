...
class MHCAttnNet(nn.Module):
    ...
    def __init__(self, peptide_embedding, mhc_embedding):
        ...
        self.peptide_linear = nn.Linear(2*self.hidden_size*self.peptide_num_layers, config.LINEAR1_OUT)
        self.mhc_linear = nn.Linear(2*self.hidden_size*self.mhc_num_layers, config.LINEAR1_OUT)
